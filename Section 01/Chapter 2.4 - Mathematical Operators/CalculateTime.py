...
#Add your code here!
hoursAsMinutes = (start_hour * 60) + start_minute
newLength = length + hoursAsMinutes

lengthAsHours = newLength // 60
lengthAsMinutes = newLength % 60
print(str(lengthAsHours) + ":" + str(lengthAsMinutes))